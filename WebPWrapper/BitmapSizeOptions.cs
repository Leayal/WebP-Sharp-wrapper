...
namespace WebPWrapper
{
    ...
    public class BitmapSizeOptions
    {
        ...
        public static BitmapSizeOptions FromHeight(int pixelHeight)
        {
            if (pixelHeight <= 0)
            {
                throw new ArgumentOutOfRangeException(nameof(pixelHeight), "Parameter must be greater than zero.");
            }
        ...
        public static BitmapSizeOptions FromWidth(int pixelWidth)
        {
            if (pixelWidth <= 0)
            {
                throw new ArgumentOutOfRangeException(nameof(pixelWidth), "Parameter must be greater than zero.");
            }
