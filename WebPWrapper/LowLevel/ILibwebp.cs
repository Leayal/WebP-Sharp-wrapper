...
namespace WebPWrapper.LowLevel
{
    ...
    public interface ILibwebp
    {
        ...
        /// </remarks>
        int WebPConfigInit(ref WebPConfig config, WebPPreset preset, float quality_factor);
        ...
        VP8StatusCode WebPGetFeatures(IntPtr rawWebP, UIntPtr data_size, ref WebPBitstreamFeatures features);
        ...
        int WebPConfigLosslessPreset(ref WebPConfig config, CompressionLevel level);
        ...
        int WebPGetInfo(IntPtr data, UIntPtr data_size, out int width, out int height);

        /// <summary>Validate the WebP image header.</summary>
        /// <param name="data">Pointer to WebP image data</param>
        /// <param name="data_size">This is the size of the memory block pointed to by data containing the image data</param>
        /// <returns>1 if success, otherwise error code returned in the case of (a) formatting error(s).</returns>
        int WebPGetInfo(IntPtr data, UIntPtr data_size);
        ...
        IntPtr WebPDecodeRGBAInto(IntPtr data, UIntPtr data_size, IntPtr output_buffer, UIntPtr output_buffer_size, int output_stride);
        ...
        /// <param name="output_stride">Specifies the distance between scanlines</param>
        /// <returns>output_buffer if function succeeds; NULL otherwise</returns>
        IntPtr WebPDecodeARGBInto(IntPtr data, UIntPtr data_size, IntPtr output_buffer, UIntPtr output_buffer_size, int output_stride);
        ...
        /// <param name="output_stride">Specifies the distance between scanlines</param>
        /// <returns>output_buffer if function succeeds; NULL otherwise</returns>
        IntPtr WebPDecodeBGRAInto(IntPtr data, UIntPtr data_size, IntPtr output_buffer, UIntPtr output_buffer_size, int output_stride);
        ...
        /// <param name="output_stride">Specifies the distance between scanlines</param>
        /// <returns>output_buffer if function succeeds; NULL otherwise</returns>
        IntPtr WebPDecodeRGBInto(IntPtr data, UIntPtr data_size, IntPtr output_buffer, UIntPtr output_buffer_size, int output_stride);
        ...
        /// <param name="output_stride">Specifies the distance between scanlines</param>
        /// <returns>output_buffer if function succeeds; NULL otherwise</returns>
        IntPtr WebPDecodeBGRInto(IntPtr data, UIntPtr data_size, IntPtr output_buffer, UIntPtr output_buffer_size, int output_stride);
        ...
        VP8StatusCode WebPDecode(IntPtr data, UIntPtr data_size, ref WebPDecoderConfig webPDecoderConfig);
        ...
        UIntPtr WebPEncodeBGR(IntPtr bgr, int width, int height, int stride, float quality_factor, out IntPtr output);
        ...
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        /// <returns></returns>
        UIntPtr WebPEncodeRGB(IntPtr rgb, int width, int height, int stride, float quality_factor, out IntPtr output);
        ...
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        /// <returns></returns>
        UIntPtr WebPEncodeBGRA(IntPtr bgra, int width, int height, int stride, float quality_factor, out IntPtr output);
        ...
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        /// <returns></returns>
        UIntPtr WebPEncodeRGBA(IntPtr rgba, int width, int height, int stride, float quality_factor, out IntPtr output);
        ...
        /// <param name="output">output_buffer with WebP image</param>
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        UIntPtr WebPEncodeLosslessBGR(IntPtr bgr, int width, int height, int stride, out IntPtr output);
        ...
        /// <param name="output">output_buffer with WebP image</param>
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        UIntPtr WebPEncodeLosslessBGRA(IntPtr bgra, int width, int height, int stride, out IntPtr output);
        ...
        /// <param name="output">output_buffer with WebP image</param>
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        UIntPtr WebPEncodeLosslessRGB(IntPtr rgb, int width, int height, int stride, out IntPtr output);
        ...
        /// <returns>Size of WebP Image or 0 if an error occurred</returns>
        /// <returns></returns>
        UIntPtr WebPEncodeLosslessRGBA(IntPtr rgba, int width, int height, int stride, out IntPtr output);
        ...
        IntPtr WebPIDecode(IntPtr input_buffer, UIntPtr input_buffer_size, ref WebPDecoderConfig config);
        ...
        IntPtr WebPINewRGB(Colorspace colorspace, IntPtr output_buffer, UIntPtr output_buffer_size, int output_stride);
